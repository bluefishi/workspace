 ...
 * interface persistent, it is enought to simply call <code>writeXML()</code> with
 ...
 * vaild objects.<br>
 * <br>
 * <b>Please note</b>, that there is no mechanism to dedect cycles during the
 * serialization process. Due to the recursive design of this interface deep
 * object structures meight raise a <code>java.lang.StackOverflowError</code>.
 *
